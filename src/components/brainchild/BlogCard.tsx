    ...
    >
      ...
      <div className="relative aspect-[16/10] overflow-hidden rounded-[2rem] mb-6">
        <img
          src={post.coverImage}
          alt={post.title}
          /* Fixed the ambiguous duration by using a standard Tailwind class */
          className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 ease-out"
        />
        
        {/* Date Badge */}
        <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-md px-4 py-2 rounded-2xl flex flex-col items-center border border-white/50">
      ...
      <div className="flex flex-col flex-grow px-2">
        ...
        <p className="text-sm text-slate-500 font-body line-clamp-2 mb-6 leading-relaxed">
          {post.excerpt}
        </p>
