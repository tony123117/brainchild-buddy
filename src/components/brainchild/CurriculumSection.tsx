...
export function CurriculumSection() {
  return (
    <section className="section-pink px-4 md:px-12 lg:px-24 py-12 md:py-24 font-body relative overflow-hidden">
      <div className="absolute top-8 right-12 text-3xl animate-float opacity-25">📖</div>
      <div className="absolute bottom-12 left-8 text-4xl animate-wiggle opacity-20">🌍</div>

      <div className="max-w-[1400px] mx-auto">
        <AnimatedSection>
          <div className="text-center mb-12">
            <span className="text-xs font-semibold text-primary bg-white/60 px-3 py-1 rounded-full inline-block mb-3">📝 Curriculum</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <AnimatedSection delay={0.1}>
            ...
            >
              <div className="flex items-center gap-3 mb-5">
                ...
                <h3 className="text-xl font-heading font-bold text-secondary">Pre-School & KG 1–3</h3>
              </div>
          ...
          <AnimatedSection delay={0.2}>
            ...
            >
              <div className="flex items-center gap-3 mb-5">
                <span className="text-2xl">🎓</span>
                <h3 className="text-xl font-heading font-bold text-primary">Elementary 1–6</h3>
              </div>
              <div className="flex flex-wrap gap-2">
