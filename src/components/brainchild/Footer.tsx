...
export function Footer() {
  return (
    <footer className="bg-footer-bg font-heading mt-24 md:mt-48">
      <AnimatedSection>
        <div className="px-4 md:px-12 lg:px-24 pt-12 md:pt-48">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 md:gap-12">
            {/* Brand */}
            <div className="flex flex-col gap-4 text-muted-foreground col-span-2 md:col-span-1">
