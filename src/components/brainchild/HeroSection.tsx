...
export function HeroSection() {
  return (
    <div className="relative overflow-hidden font-heading min-h-screen section-hero-pink">
      ...
      <div className="flex flex-col items-center justify-center gap-6 md:gap-8 py-10 md:py-20 px-4 relative z-20">
        ...
        >
          <motion.span
            className="inline-block bg-white/25 backdrop-blur-sm text-white text-xs md:text-sm font-semibold px-4 py-1.5 rounded-full mb-4 border border-white/30"
          ...
          <div className="leading-tight md:leading-[3.5rem] mt-2">
            <span className="text-white text-3xl md:text-5xl lg:text-[60px] font-bold drop-shadow-md">
              Unlock a More
            </span>
        ...
        <motion.p
          ...
          className="max-w-[600px] text-center md:text-base px-4 text-white/90 leading-relaxed drop-shadow-sm"
        >
